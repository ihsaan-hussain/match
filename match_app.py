...
class App:
    ...
    def __init__(self,main):
        ...
        self.save_score = Button(scorelabelframe,text="Save score",bg="light grey",font=("Helvetica",20,'bold'),bd=5,width=20)
        ...
        self.create_spreadsheet = Button(buttonlabelframe, bd=5, bg="light grey", font=("Helvetica",15,'bold'), text="Create Spreadsheet", width=25)
        self.create_spreadsheet.grid(row=0,column=0,padx=10,pady=10)
